...
const HOSTED_ZONE_ID = "Z04383883QEAHR63I6VSN";

const HOSTED_ZONE_NAME  = `${DOMAIN_NAME}`;
const S3_BUCKET_DEV     = `dev.${DOMAIN_NAME}`;
const S3_BUCKET_PROD    = `${DOMAIN_NAME}`;
const CF_HOSTED_ZONE_ID = "Z2FDTNDATAQYW2";

export class Lumanation2 extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const sslCertificate = new cert.Certificate(this, "Lumanation2-cert", {
      ...
      validation: cert.CertificateValidation.fromDnsMultiZone({
        [`${DOMAIN_NAME}`]: route53HostedZone,
        [`*.${DOMAIN_NAME}`]: route53HostedZone,
        [`dev.${DOMAIN_NAME}`]: route53HostedZone,
        [`*.dev.${DOMAIN_NAME}`]: route53HostedZone
      })
    });
    ...
    // const s3BucketDevWebsite = new s3.Bucket(this, "Lumanation2-s3-dev-website", {
    //   bucketName: S3_BUCKET_DEV,
    //   ...s3BaseRules
    // });

    const s3BucketProdWebsite = new s3.Bucket(this, DOMAIN_NAME, {
    ...
    // const dynamoDevTableName  = "Lumanation2-dynamo-dev";
    // const dynamoProdTableName = "Lumanation2-dynamo-prod";
    ...
    // const iamRoleLambdaDev = new iam.Role(this, "Lumanation2-LambdaRole-dev", {
    ...
    // const iamRoleLambdaProd = new iam.Role(this, "Lumanation2-LambdaRole-prod", {
    //   assumedBy: new iam.ServicePrincipal("lambda.amazonaws.com"), // Allow Lambdas to assume this role
    //   managedPolicies: [
    //     iam.ManagedPolicy.fromAwsManagedPolicyName("service-role/AWSLambdaBasicExecutionRole")
    //   ],
    ...
    // const lambdaApiDev = new lambda.Function(this, "Lumanation2-api-dev", {
    //   functionName: "Lumanation2-api-dev",
    ...
    // const lambdaApiProd = new lambda.Function(this, "Lumanation2-api-prod", {
    //   functionName: "Lumanation2-api-prod",
    //   runtime: lambda.Runtime.NODEJS_20_X,
    //   handler: "index.handler",
    //   code: lambda.Code.fromAsset("./bin/lambda.zip"),
    //   memorySize: 1024,
    ...
    // const cfDevApi = new cf.Distribution(this, "Lumanation2-cf-dev-api", {
    //   domainNames: ["api.dev.luma-nationcommercial.com"],
    ...
    // const cfDevWebsite = new cf.Distribution(this, "Lumanation2-cf-dev-website", {
    //   domainNames: ["dev.luma-nationcommercial.com"],
    //   certificate: sslCertificate,
    //   httpVersion: cf.HttpVersion.HTTP2_AND_3,
    //   minimumProtocolVersion: cf.SecurityPolicyProtocol.TLS_V1_2_2021,
    //   defaultBehavior: {
    ...
    // const cfProdApi = new cf.Distribution(this, "Lumanation2-cf-prod-api", {
    //   domainNames: ["api.luma-nationcommercial.com"],
    //   certificate: sslCertificate,
    //   httpVersion: cf.HttpVersion.HTTP2_AND_3,
    //   minimumProtocolVersion: cf.SecurityPolicyProtocol.TLS_V1_2_2021,
    //   defaultBehavior: {
    ...
    const cfProdWebsite = new cf.Distribution(this, "Lumanation2-cf-prod-website", {
      domainNames: ["luma-nationcommercial.com"],
      certificate: sslCertificate,
      httpVersion: cf.HttpVersion.HTTP2_AND_3,
      minimumProtocolVersion: cf.SecurityPolicyProtocol.TLS_V1_2_2021,
      defaultBehavior: {
